...
public class RegionAdapter extends RecyclerView.Adapter<RegionAdapter.MyHolder> {
    private List<RegionModel> arrayList;
    Context mContext;
    OnCustomSingleClickListener onCustomClickListener;

    public RegionAdapter(Context mContext, OnCustomSingleClickListener onCustomClickListener, List<RegionModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        holder.tvTitleName.setText(arrayList.get(position).getRegion());
        holder.rLayoutHead.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onCustomClickListener.onCustomSingleClick(arrayList.get(position).getRegion());
            }
        });
    }
    @Override
