...
public class PrepaidRechargeAdapter extends RecyclerView.Adapter<PrepaidRechargeAdapter.MyHolder> {
    private List<PrepaidResponseModel> arrayList;
    Context mContext;
    OnCustomThreeClickListener onCustomClickListener;

    public PrepaidRechargeAdapter(Context mContext, OnCustomThreeClickListener onCustomClickListener, List<PrepaidResponseModel> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.rLayoutHead.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onCustomClickListener.onCustomThreeClick(String.valueOf(arrayList.get(position).getId()),arrayList.get(position).getProviderName(),arrayList.get(position).getLogo());
            }
        });
    }
