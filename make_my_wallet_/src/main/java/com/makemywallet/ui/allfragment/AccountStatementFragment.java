...
import com.makemywallet.databinding.FragmentAccountStatimentBinding;
...
public class AccountStatementFragment extends Fragment {
    FragmentAccountStatimentBinding binding;
    Activity mActivity;
    ProgressDialog pd;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentAccountStatimentBinding.inflate(inflater, container, false);
    ...
    private void getAccountStatement() {
        ...
        try {
            ...
            String url = ApplicationConstant.INSTANCE.GET_ACCOUNT_STATEMENT + "?username=" + mobile + "&password=" + mPassword + "&fromdate=" + mFromDate + "&todate=" + mToDate;
            Log.d(">>>>>>.", ">????" + url);
                        ...
                        if (response != null && response.length() > 0) {
                            try {
                                ...
                                if (arrayList.size() > 0) {
                                    ...
                                    AccountStatementAdapter adapter = new AccountStatementAdapter(mActivity, arrayList);
