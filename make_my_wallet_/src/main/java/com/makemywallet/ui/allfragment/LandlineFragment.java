...
public class LandlineFragment extends Fragment implements OnCustomClickListener {
    private static final String TAG = "LandlineFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_landline, container, false);
    ...
    private void getBottomSheet() {
        ...
        if (prepaidResponses.size() > 0) {
            ...
            CustomAdapter adapter = new CustomAdapter(mActivity, LandlineFragment.this, prepaidResponses);
    ...
    public void onResume() {
        super.onResume();
        ((MainActivity) getActivity()).setActionBarTitle(getResources().getString(R.string.landline_recharge));
    }
