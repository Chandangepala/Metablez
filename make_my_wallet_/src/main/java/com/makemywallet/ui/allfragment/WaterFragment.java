...
public class WaterFragment extends Fragment implements OnCustomClickListener {
    ...
    private void getBottomSheet() {
        ...
        if (prepaidResponses.size() > 0) {
            ...
            CustomAdapter adapter = new CustomAdapter(mActivity, WaterFragment.this, prepaidResponses);
    ...
    public void onResume() {
        super.onResume();
        ((MainActivity) getActivity()).setActionBarTitle(getResources().getString(R.string.water));
    }
