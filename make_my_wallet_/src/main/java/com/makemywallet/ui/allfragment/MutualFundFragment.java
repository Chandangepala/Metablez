 ...
 * Use the {@link MutualFundFragment#newInstance} factory method to
...
public class MutualFundFragment extends Fragment {
    ...
    public static MutualFundFragment newInstance(String param1, String param2) {
        MutualFundFragment fragment = new MutualFundFragment();
